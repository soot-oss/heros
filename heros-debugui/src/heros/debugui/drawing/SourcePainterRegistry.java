...
public class SourcePainterRegistry {
	 ...
	 */
	public static synchronized SPArrow registerArrow(String path, int startLine, int startCol, int endLine, int endCol)
	{ 
	 ...
	 */
	public static synchronized List<SPArrow> getArrowsOfFile(String path)
	{
	 ...
	 */
	public static synchronized boolean removeArrowOfFile(SPArrow arrow, String path)
	{
	 ...
	 */
	public static synchronized void trashArrow(SPArrow arrow) 
	{
	 ...
	 */
	public static synchronized void emptyTrashOfArrows()
	{
	 ...
	 * 
	 */
	public static synchronized SPTextLabel registerTextLabel(String path, int lineNumber, String labelText)
	{
		if (path == null || path.isEmpty() ||
	 ...
	 */
	static synchronized boolean hasTextLabelsOfFile(String path)
	{
	 ...
	 */
	static synchronized List<SPTextLabel> getTextLabelsOfFile(String path)
	{
	 ...
	 * @return true if the removal is successful, false otherwise
	 */
	public static synchronized boolean removeTextLabelOfFile(SPTextLabel label, String path)
	{
	 ...
	 */
	public static synchronized void trashTextLabel(SPTextLabel label)
	{
	 ...
	 */
	public static synchronized void emptyTrashOfTextLabels()
	{
	 ...
	 */
	static synchronized void registerHover(int shadowId, Label label)
	{
	 ...
	 */
	static synchronized boolean hasHover(int shadowId)
	{
	 ...
	 */
	static synchronized Label getHover(int shadowId)
	{
	 ...
	 * @param shadowId shadow ID of the transition
	 */
	static synchronized void trashHover(int shadowId)
	{
	 ...
	 */
	public synchronized static void trashAllHoversOfFile(String filename)
	{
	 ...
	 */
	static synchronized boolean hasTrashedHover()
	{
	 ...
	 */
	static synchronized Label getNextTrashedHover()
	{
	 ...
	 */
	static synchronized void emptyTrashOfHovers()
	{
	 ...
	 */
	public synchronized static void registerHoverImage(int shadowId, ImageData image)
	{
	 ...
	 */
	static synchronized boolean hasHoverImage(int shadowId)
	{
	 ...
	 */
	public synchronized static ImageData getHoverImage(int shadowId)
	{
	 ...
	 * @param shadowId the shadow ID of the transition
	 */
	public synchronized static void removeHoverImage(int shadowId)
	{
	 ...
	 */
	public synchronized static void registerContextMenu(String thePath, int theShadowId, int line, int column, int endColumn, SortedMap<String, SortedMap<String, Integer>> theTransitions)
	{
	 ...
	 */
	static synchronized boolean hasContextMenusOfFile(String path)
	{
	 ...
	 */
	static synchronized List<SPContextMenu> getContextMenusOfFile(String path)
	{
	 ...
	 */
	public synchronized static void trashContextMenu(SPContextMenu menu) 
	{
	 ...
	 * in shadow ID map
	 */
	public synchronized static void emptyTrashOfContextMenus()
	{
	 ...
	 */
	static synchronized void registerContextMenuLabel(int shadowId, Label label)
	{
	 ...
	 */
	static synchronized boolean hasContextMenuLabel(int shadowId)
	{
	 ...
	 */
	static synchronized void removeContextMenuLabelOfFile(int id, String filename)
	{
	 ...
	 * @param filename absolute file path
	 */
	public synchronized static void removeAllContextMenuLabelsOfFile(String filename)
	{
		if (contextMenusMap.containsKey(filename)) {
			for (SPContextMenu menu : contextMenusMap.get(filename)) {
				int id = menu.shadowId;
	 ...
	 */
	public synchronized static void registerFilePath(String fileOSPath) 
	{
	 ...
	 */
	public synchronized static String getOSPath(String filename)
	{
